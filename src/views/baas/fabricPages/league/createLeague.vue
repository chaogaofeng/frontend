            ...
            <div class="box border">
              ...
              <div class="form">                
                <el-form-item label="初始组织：" prop="defaultOrgan" class="label imp">
                  ...
                  >                    
                    ...
                    >
                      ...
                      >
                        <div v-if="item.label === '创建组织'" class="create">
                          <el-button type="text" icon="el-icon-plus" @click="crateOrgan">{{
                            item.label
                          }}</el-button>
                        </div>
                        <span v-else style="font-size: 12px">{{ item.label }}</span>
                      </el-option>
                    </el-option-group>
                  </el-select>
                </el-form-item>
                ...
                <el-form-item label="联盟描述：" class="label imp">
                  <el-input type="textarea" placeholder="请输入阻止描述" style="width:500px;" :rows="5" minlength="1" maxlength="200" resize="none" v-model="createForm.desc" show-word-limit />
                </el-form-item> 

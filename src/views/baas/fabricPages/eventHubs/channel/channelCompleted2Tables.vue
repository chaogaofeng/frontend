<template>
  <div class="page-item">
    ...
    <div class="show-datalist">
      <el-table
        :data="applyChannelCompletedEventTable"
        :border="false"
        style="width: 100%"
      ...
      <el-pagination class="pagination" v-if="pageChannelCompletedApply.total" @current-change="changeChannelCompletedApply" :current-page="pageChannelCompletedApply.currentPage" layout="prev, pager, next" :total="pageChannelCompletedApply.total" background />
    </div>
    <el-row type="flex" class="item-row-base">
      <el-col :span="16">
    ...
    <div class="show-datalist">
      <el-table
        :data="approvalChannelCompletedEventTable"
        :border="false"
        style="width: 100%"
        header-cell-class-name="table-header"          
        :cell-style="{
      ...
      <el-pagination class="pagination" v-if="pageChannelCompletedApproval.total" @current-change="changeChannelCompletedApproval" :current-page="pageChannelCompletedApproval.currentPage" layout="prev, pager, next" :total="pageChannelCompletedApproval.total" background />
    </div>
...
export default {
  name: 'EventChannelCompleted',
  components: {
    XIcon
  },
  data() {
    return {
      applyChannelCompletedEventTable: [{
      ...
      approvalChannelCompletedEventTable: [{
        eventName: '',
        initiator: '',
        relatedChannel: '',
        eventState: '',
      ...
      pageChannelCompletedApply: {
        total: 0,
        currentPage: 1,
        pageSize: 10,
      },
      pageChannelCompletedApproval: {
        total: 0,
        currentPage: 1,
        pageSize: 10,
      },
  ...
  methods: {
    ...
    changeChannelCompletedApply(pageNo) {
      this.pageChannelCompletedApply.currentPage = pageNo;
    },
    changeChannelCompletedApproval(pageNo) {
      this.pageChannelCompletedApproval.currentPage = pageNo;
    },
    viewApprovalFlow() {
      // alert("查看审批流！");

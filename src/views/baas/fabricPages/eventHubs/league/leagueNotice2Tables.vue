<template>
  <div class="page-item">
    <div class="show-datalist">
      ...
      <el-pagination class="pagination" v-if="pageChannelNotice.total" @current-change="changeChannelNoticePage" :current-page="pageChannelNotice.currentPage" layout="prev, pager, next" :total="pageChannelNotice.total" background />
    </div>
...
export default {
  name: 'EventLeagueNotice',
  data() {
    return {
      channelNoticeEventTable: [
        {
          eventName: '用户同意加入联盟',
          initiator: '联盟01',
  ...
  methods: {
    ...
    changeChannelNoticePage(pageNo) {
      this.pageChannelNotice.currentPage = pageNo;
    },
  },
}
</script>
